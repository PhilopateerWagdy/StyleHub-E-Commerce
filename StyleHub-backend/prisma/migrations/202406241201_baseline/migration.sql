...
-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('MEN', 'WOMEN', 'BOY', 'GIRL');

-- CreateEnum
CREATE TYPE "Fit" AS ENUM ('SLIM', 'REGULAR', 'OVERSIZE', 'RELAXED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'CASH_ON_DELIVERY', 'INSTAPAY', 'VODCASH');
...
-- CreateIndex
CREATE UNIQUE INDEX "Category_name_parentId_gender_key" ON "Category"("name", "parentId", "gender");
